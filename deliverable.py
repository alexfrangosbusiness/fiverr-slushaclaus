...
def getOriginalFullPlayer():
    ...
    df_players_all.to_csv("/Users/anola/Documents/Fiverr/Me/Automations/Order-slushaclaus/players.csv",index=False)
...
def getDesiredRosters(df_rosters_original,df_players_all):
    ...
    df_rosters_all.to_csv("/Users/anola/Documents/Fiverr/Me/Automations/Order-slushaclaus/test.csv")
